...
class EmbeddingManager(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        print("Per Image Tokens:")
        print(per_image_tokens)
        ...
        # raise
        # num_vectors_per_token = 13
        print(f"Setting NVPT to {num_vectors_per_token}")
        ...
        if per_image_tokens:
            print("Per Image Token Alert!")
            print(per_img_token_list)
